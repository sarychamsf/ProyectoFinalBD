...
<html>
    <head>
        ...
        <title>Eliminar Trabajo a Realizar</title>
        <!--
        Ocean Theme
        ...
        <div class="row tm-section">
            ...
            <section class="tm-section-contact">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-xs-center">
                    ...
                    <h2 class="tm-section-title">Eliminar Trabajo a Realizar</h2>
                    <br><br>

                </div>
                <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 tm-form-group-left">
                    <form align="center" action="TrabajoARealizarM" method="GET" class="tm-contact-form">                                
                        <label align="center" for="idT">Escoja el trabajo que desea eliminar</label>
