        ...
        <div class="row tm-section">
            <section class="tm-section-contact">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-xs-center">
                    <h2 class="tm-section-title">Reporte de Servicios</h2>
                    <br><br>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-xs-center">
                    <p> Se muestra la cantidad de funciones por cada servicio (activo y con más de dos funciones).</p>
                </div>
            </section>
        </div>
            ...
            <table class="table table-inverse">
                ...
                <%
                  if (request.getAttribute("reporte") != null) {
                            ArrayList<ReporteServicio> array = (ArrayList<ReporteServicio>) request.getAttribute("reporte");
                            for (ReporteServicio r : array) {
                %>
                <thead>
                    <tr>
                        <th><%=r.getNombre()%></th>
